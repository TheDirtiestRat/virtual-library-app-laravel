        ...
        <div class="bg-amber-50 rounded-xl p-4 basis-full">
            <div class="basis-full grid grid-cols-3 gap-2 h-full">
                ...
                <div class="col-span-full">
                    ...
                    <div class="flex flex-row">
                        ...
                        <button type="button" id="isbn-exists"
                            class="bg-amber-100 hover:bg-amber-200 shadow-md border border-gray-200 p-2 h-auto rounded-e-xl hover:border-gray-300 focus:outline-2 whitespace-nowrap">Check
                            ISBN</button>
                    </div>
                </div>
                ...
                <input type="text" name="categories" id="categories" placeholder="Categories"
                    class="w-full p-2 bg-white border border-gray-300 rounded-xl mb-2 col-span-full @error('categories') border-red-500 @enderror" />
