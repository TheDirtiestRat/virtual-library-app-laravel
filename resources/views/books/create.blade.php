    ...
    <form method="POST" action="{{ url('/books/manage/storeBook') }}" class=" h-full basis-full flex flex-row gap-4"
        ...
        <div class="bg-white rounded-xl p-4 basis-full">
            <div class="basis-full grid grid-cols-3 gap-2 h-full">
                ...
                <div class="col-span-full">
                    ...
                    <div class="flex flex-row">
                        <input type="text" name="isbn" id="isbn" placeholder="ISBN"
                            class="w-full p-2 border border-gray-300 rounded-s-xl" required value="" />
                        <button type="button" id="isbn-exists"
                            class="bg-white shadow-md border border-gray-200 p-2 h-auto rounded-e-xl hover:border-gray-300 hover:bg-gray-300 focus:outline-2 whitespace-nowrap">Check
                            ISBN</button>
                    </div>
                </div>
                ...
                {{-- other fields --}}
                <div class="col-span-full">
                    <label for="isbn">Book Title <span class="text-red-400">*</span> @error('title')
                            <span class="text-red-400">Enter Book Title</span>
                        @enderror
                    </label>
                    <input type="text" name="title" id="title" placeholder="Title"
                        class="w-full p-2 border border-gray-300 rounded-xl col-span-ful"
                        required value="" />
                </div>
                ...
                <input type="text" name="authors" id="authors" placeholder="Authors (comma separated)"
                    class="w-full p-2 border border-gray-300 rounded-xl mb-2 @error('authors') border-red-500 @enderror"
                    value="" />
                ...
                <input type="text" name="categories" id="categories" placeholder="Categories"
                    class="w-full p-2 border border-gray-300 rounded-xl mb-2 col-span-full @error('categories') border-red-500 @enderror" />
                ...
                <button type="submit"
                    class="bg-white shadow-md border border-gray-200 p-3 rounded-xl hover:border-gray-300 hover:bg-gray-300 focus:outline-2 col-span-full">Add
                    Book</button>
            </div>
        </div>
